...
if __name__ == '__main__':
    print('55555')
    ip_spider = Crawler()
    # ip_spider.crawl_xicidaili()
    for callback_label in range(ip_spider.__CrawlFuncCount__):
        callback = ip_spider.__CrawlFunc__[callback_label]
        # 获取代理
        proxies = ip_spider.get_proxies(callback)
        print(proxies)
        # sys.stdout.flush()
        # for proxy in proxies:
            # self.redis.add(proxy)
    # ip_demo = ip_spider.get_proxies()
